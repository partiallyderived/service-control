...
def test_service() -> None:
    # Just test that EAClientService instantiates an EAClient with the appropriate arguments.
    config = {'app': 'AppName', 'key': 'MyKey'}
    with mock.patch('servicecontrol.everyaction.client.EAClient', autospec=True) as mock_client_class:
